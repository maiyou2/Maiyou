...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
      ...
      <dl>
        <button type="button" class="am-btn am-btn-danger am-round am-btn-xs am-icon-plus" > 手动添加套餐</button>
      </dl>
      <!--这里打开的是新页面-->
          ...
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            <thead>
              <tr class="am-success">
                ...
                <th class="table-type">套餐价格</th>
                <th class="table-author am-hide-sm-only">开始结束时间</th>
                  <th class="table-type">套餐酒店</th>
                  <th class="table-type">套餐机票</th>
